  ...
  return (
    <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        ...
        />
        <motion.div
          className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-gold-600/10 rounded-full blur-3xl"
          animate={{
            scale: [1.2, 1, 1.2],
            opacity: [0.5, 0.3, 0.5],
          }}
      ...
      <div className="container mx-auto px-6 z-10 text-center">
        ...
        >
          ...
          >
            Découvrez les époques les plus fascinantes de l'Histoire avec notre agence de voyages temporels de luxe
          </motion.p>
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 bg-gradient-to-r from-gold-500 to-gold-600 text-zinc-950 font-bold rounded-lg text-lg shadow-lg shadow-gold-500/50 hover:shadow-gold-500/70 transition-all"
            >
              Réserver maintenant
            </motion.button>
            <motion.button
